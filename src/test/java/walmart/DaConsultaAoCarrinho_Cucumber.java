...
public class DaConsultaAoCarrinho_Cucumber {
	...
	public void Print(String nomePrint) throws IOException {
		...
		new File("C:\\Users\\Gabriel Correia\\git\\fts120b\\target\\evidencias\\" + pastaPrint + "\\" + nomePrint + ".png"));
	}
...
*/
	...
	public void Iniciar() {
		...
		"C:\\Users\\Gabriel Correia\\git\\fts120b\\drivers\\chrome\\74\\chromedriver.exe");
